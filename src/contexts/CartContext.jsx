...
const CartProvider = ({ children }) => {
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const res = await axios.get("https://testnodebe.onrender.com/users/userProduct/");
        // setMyUser(res.data);
  ...
  const AddToMyCart = (x) => {
    ...
    if (!newComp) {
      axios
        .post("https://testnodebe.onrender.com/users/userProduct/", {
          ...x,
        })
        .then((res) => {
          console.log(res);
      ...
      axios
        .put(`https://testnodebe.onrender.com/users/userProduct/` + x._id, {
          ...x,
  ...
  const deleteCartItem = (x) => {
    ...
    if (confirm) {
      axios
        .delete(`https://testnodebe.onrender.com/users/userProduct/` + x)
        .then((res) => {
          location.reload();
        })
        .catch((err) => console.log(err));
  ...
  const AddMoreToMyCart = (x) => {
    ...
    if (!newComp) {
      axios
        .post("https://testnodebe.onrender.com/users/userProduct/", { ...x })
        .then((res) => {
          console.log(res);
        })
        .catch((err) => console.log(err));
  ...
  const increaseAmount = (id) => {
    ...
    state.cartProducts.map((item) => {
      ...
      if (item._id == id) {
        ...
        axios
          .put(`https://testnodebe.onrender.com/users/userProduct/` + id, {
            ...item,
            amount: incAmount,
          })
          .then((res) => {
